...
export class NgxSmartDatatableComponent implements OnInit, AfterViewInit {
    ...
    ngOnInit(): void {
        this.ngxSmartDatatableSvc.lazyLoadDataTableMainLib().subscribe((_) => {
            ...
            this.settings.colReorder &&
                libs.push(this.ngxSmartDatatableSvc.lazyLoadDataTableColReorderLib());
            this.settings.rowReorder &&
                libs.push(this.ngxSmartDatatableSvc.lazyLoadDataTableRowReorderLib());
            this.settings.select &&
                libs.push(this.ngxSmartDatatableSvc.lazyLoadDataTableSelectLib());
            this.settings.fixedHeader &&
                libs.push(this.ngxSmartDatatableSvc.lazyLoadDataTableFixedHeaderLib());
            this.settings.fixedColumns &&
                libs.push(this.ngxSmartDatatableSvc.lazyLoadDataTableFixedColumnsLib());
            this.settings.autoFill &&
                libs.push(this.ngxSmartDatatableSvc.lazyLoadDataTableAutoFillLib());
            this.settings.keys &&
                libs.push(this.ngxSmartDatatableSvc.lazyLoadDataTableKeyTableLib());
            this.settings.responsive &&
                libs.push(this.ngxSmartDatatableSvc.lazyLoadDataTableResponsiveLib());
            this.settings.rowGroup &&
                libs.push(this.ngxSmartDatatableSvc.lazyLoadDataTableRowGroupLib());
            this.settings.scroller &&
                libs.push(this.ngxSmartDatatableSvc.lazyLoadDataTableScrollerLib());
            this.settings.searchPanes &&
                libs.push(this.ngxSmartDatatableSvc.lazyLoadDataTableSearchPanesLib());
